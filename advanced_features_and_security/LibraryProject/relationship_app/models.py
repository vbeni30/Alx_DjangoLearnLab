...
from django.contrib.auth.models import AbstractUser, BaseUserManager # Added these imports
...
class UserProfile(models.Model):
    ...
    # IMPORTANT: Reference settings.AUTH_USER_MODEL instead of 'User'
...
# Signals - Update sender to settings.AUTH_USER_MODEL
